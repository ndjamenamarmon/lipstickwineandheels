        ...
        <div style={{ background: '#fff' }}>
          ...
          <div className={styles.pageContainer}>
            ...
            <p>
              ...
              instead with crimson color (see color section).
            </p>
            <h1>Heading One</h1>
            <p>
            ...
            <p>
              There is{' '}
              <span style={{ color: '#D51034' }}>one accent color</span>, all
              other colors are monochromatic grays, except when depicting code
